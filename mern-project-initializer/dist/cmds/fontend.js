...
import ora from "ora";
import { getInstallCmd, setupPrettierConfig } from "../helper.js";
/**
 ...
 */
function runVite(command, package_manager) {
    try {
        const spinner = ora("Installing Vite...").start();
        const installCommand = package_manager === "yarn"
        ...
        if (installResult.code !== 0) {
            ...
            throw new Error(`Package installation failed: ${installResult.stderr || "Unknown error."}`);
        }
 ...
 */
export function setupClient(user_requirements) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            shell.cd("./client");
            // Installing Packages
            const install_command = yield getInstallCmd(user_requirements);
